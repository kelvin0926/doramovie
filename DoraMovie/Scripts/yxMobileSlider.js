...
(function ($) {
    $.fn.yxMobileSlider = function (settings) {
        ...
        return this.each(function () {
            ...
            //初始化焦点容器及按钮
            _this.append('<div class="focus"><label></label><div></div></div>');
            ...
            $(window).bind('resize load', function () {
                ...
                if (settings.parent != undefined) {
                    s.width = settings.parent.width();
                    s.height = settings.parent.height();
                    _this.width(s.width).height(s.height);
                    moveWidth = s.width;
                }
                ...
                oFocusContainer.find("label").css("line-height", oFocusContainer.height() + "px");
                oFocusContainer.find("label").text(oLi.eq(0).find("img").attr("alt"));
                _this.fadeIn(300);
            });
            //页面加载完毕BANNER自动滚动
            autoMove();
            ...
            function doMove() {
                ...
                oFocusContainer.find("label").text(oLi.eq(iCurr).find("img").attr("alt"));
            }
            //绑定触摸事件
